...
def main():
    ...
    # allServers = list_servers(k5token).json()['servers']
    # for server in allServers:
    #     try:
    #         if server.get('addresses')['private'][0]['addr'], "Server Bottom\n"
    #     except:
    #         print "Error Server Top\n", server.get('addresses'), "Error Server Bottom\n"
